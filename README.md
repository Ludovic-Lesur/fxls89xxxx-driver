...
|:---:|:---:|
| [sw1.3](https://github.com/Ludovic-Lesur/fxls89xxxx-driver/releases/tag/sw1.3) | >= [sw7.0](https://github.com/Ludovic-Lesur/embedded-utils/releases/tag/sw7.0) |
...
cmake -DCMAKE_TOOLCHAIN_FILE="<toolchain_file_path>" \
      ...
      -DFXLS89XXXX_DRIVER_I2C_ERROR_BASE_LAST=0 \
      -G "Unix Makefiles" ..
make all
```
